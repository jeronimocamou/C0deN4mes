    ...
    <main className="px-4 py-10 max-w-md mx-auto">
      ...
      <div className="flex items-center justify-between mb-10">
        ...
        <button
          ...
          className="font-mono text-xs text-zinc-400 hover:text-zinc-300 border border-zinc-800 px-3 py-1.5 rounded-lg transition-colors"
        >
          Sign out
        </button>
      </div>
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5 mb-4">
        <p className="font-mono text-xs text-zinc-400 uppercase tracking-wider mb-3">Display name</p>
        ...
        <p className="font-mono text-xs text-zinc-500 mt-2">this name is used in all your games</p>
      </div>

      {/* Change password */}
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5 mb-4">
        <p className="font-mono text-xs text-zinc-400 uppercase tracking-wider mb-3">Change password</p>
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
        <p className="font-mono text-xs text-zinc-400 uppercase tracking-wider mb-4">Stats</p>
        ...
        {gamesPlayed === 0 && (
          <p className="font-mono text-xs text-zinc-500 text-center mt-2">play a game to start tracking stats</p>
        )}
      </div>
...
function Stat({ label, value, color = 'text-white' }: { label: string; value: number; color?: string }) {
  return (
    <div>
      ...
      <p className="font-mono text-xs text-zinc-400 mt-1">{label}</p>
    </div>
  )
}
